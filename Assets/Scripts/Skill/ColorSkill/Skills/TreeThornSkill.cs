...
public class TreeThornSkill : SkillBase
{
    ...
    public TreeThornSkill()
        : base("treethorn", "30", "Shoots a thorn forward", "40", "1.2", "Effects/TreeThorn")
    {
    }

    public override void Execute(Player player)
    {
        Debug.Log("TreeThornSkill: Execute");
